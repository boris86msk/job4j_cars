...
-- insert into car(brand, model, body_id) values ('uaz', 'Patriot', 2);
-- insert into car(brand, model, body_id) values ('lada', 'Vesta', 1);
--
-- insert into files(path) values('src/main/resources/static/img\vesta1.jpg');
-- insert into files(path) values('src/main/resources/static/img\uazpatriot.jpg');
--
